    ...
    <div className=" flex flex-col items-center">
      <form className="flex flex-col items-center">
        ...
        <input
          ...
          className="  px-5 py-4 border-2 border-blue-300 sm:rounded-l-full sm:rounded-none rounded-full w-[60vw] focus:outline-none text-blue-500 text-lg font-semibold" required
          value={input}
